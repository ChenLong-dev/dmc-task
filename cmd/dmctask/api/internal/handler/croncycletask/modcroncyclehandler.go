...
func ModCronCycleHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ModCronCycleTaskReq
		...
		l := croncycletask.NewModCronCycleLogic(r.Context(), svcCtx)
		resp, err := l.ModCronCycle(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {

...
func DelCronHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DelFixedTimeSingleTaskReq
		...
		l := fixedtimesingletask.NewDelCronLogic(r.Context(), svcCtx)
		resp, err := l.DelCron(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {

...
func QueryCronHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.QueryFixedTimeSingleTaskReq
		...
		l := fixedtimesingletask.NewQueryCronLogic(r.Context(), svcCtx)
		resp, err := l.QueryCron(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
